...
get_runs_url = "https://app.cosmosid.com/api/metagenid/v1/files/7f4c7326-0a4e-4b56-a8d0-8ce002191672/runs?_=1622700773181"
get_analyses_url = "https://app.cosmosid.com/api/metagenid/v1/runs/437ef8e4-b595-4fd8-a2f5-64221831e925/analysis?filter=total&_=1622700773184"
get_artifacts_url = "https://app.cosmosid.com/api/metagenid/v1/runs/437ef8e4-b595-4fd8-a2f5-64221831e925/artifacts?_=1622700773185"
...
def file_runs():
    r = requests.get(get_runs_url, headers={"x-token": access_token})
    logging.info(r.json())
                                                                                                       

def file_analyses():
    r = requests.get(get_analyses_url, headers={"x-token": access_token})     
    logging.info(r.json())
